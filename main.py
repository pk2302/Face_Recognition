...
def TrackImages():
    ...
    if exists1:
        ...
        mess._show(title='Details Missing', message='Teachers details are missing, please check!')
        cam.release()
        cv2.destroyAllWindows()
        window.destroy()
    while True:
...
window.title(" Teacher Attendance System")
...
message3 = tk.Label(window, text="Teacher Attendance System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
lbl = tk.Label(frame2, text="Enter Teacher ID",width=20  ,height=1  ,fg="white"  ,bg="black" ,font=('times', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Teacher Name",width=20  ,fg="white"  ,bg="black" ,font=('times', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images \n2)Save Profile" ,bg="#00aeff" ,fg="black"  ,width=39 ,height=2, activebackground = "yellow" ,font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="white" ,fg="black"  ,width=39,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,fg="black"  ,bg="blue"  ,width=11 ,activebackground = "white" ,font=('times', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2  ,fg="black"  ,bg="blue"  ,width=11 , activebackground = "white" ,font=('times', 11, ' bold '))
